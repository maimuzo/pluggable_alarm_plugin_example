...
public class BaseAlarmActivity
    extends Activity {
    ...
    private static final int WAKELOCK_TIMEOUT_MSEC = 20000; // 20秒
    ...
    /**
     * WakeLockを取得することで電源Offでも起動できるようにし、ロックパターン表示時にも優先してアラーム画面を表示させる
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wl.acquire(WAKELOCK_TIMEOUT_MSEC);
    ...
    /**
     * プラグインと連携して次のアラームをセットし、セットできたらOnSetAlarm.onSetAlarmDone()を呼ぶ
     * 
     * @param listener
     */
    ...
    /**
     * プラグインと連携して次のスヌーズをセットし、セットできたらOnSetAlarm.onSetSnoozeDone()を呼ぶ
     * 
     * @param listener
     */
